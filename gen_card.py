...
SVG = f"""<svg xmlns="http://www.w3.org/2000/svg" width="720" height="320" viewBox="0 0 720 320">
  ...
  <!-- Gate rows: check / label / time -->
  <!-- gate rows data: (label, time_ms, pass) -->
  <!-- 1 -->
  <text x="386" y="72" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950">&#10003;</text>
  <text x="398" y="72" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">version check</text>
  <text x="700" y="72" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#484f58">0.01ms</text>

  <!-- 2 -->
  <text x="386" y="87" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950">&#10003;</text>
  <text x="398" y="87" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">action in scope</text>
  <text x="700" y="87" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#484f58">0.01ms</text>

  <!-- 3 -->
  <text x="386" y="102" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950">&#10003;</text>
  <text x="398" y="102" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">currency = INR</text>
  <text x="700" y="102" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#484f58">0.01ms</text>

  <!-- 4 -->
  <text x="386" y="117" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950">&#10003;</text>
  <text x="398" y="117" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">cap &gt; 0</text>
  <text x="700" y="117" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#484f58">0.01ms</text>

  <!-- 5 -->
  <text x="386" y="132" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950">&#10003;</text>
  <text x="398" y="132" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">merchant allowlisted</text>
  <text x="700" y="132" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#484f58">0.02ms</text>

  <!-- 6 -->
  <text x="386" y="147" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950">&#10003;</text>
  <text x="398" y="147" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">amount &gt; 0 and ≤ cap</text>
  <text x="700" y="147" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#484f58">0.02ms</text>

  <!-- 7 — the big one -->
  <text x="386" y="162" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950" filter="url(#glow-sm)">&#10003;</text>
  <text x="398" y="162" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">Ed25519 signature valid</text>
  <text x="700" y="162" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#FFBD2E">0.12ms</text>

  <!-- 8 -->
  <text x="386" y="177" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950">&#10003;</text>
  <text x="398" y="177" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">mandate not expired</text>
  <text x="700" y="177" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#484f58">0.01ms</text>

  <!-- 9 -->
  <text x="386" y="192" font-family="JetBrains Mono,monospace" font-size="9" fill="#3fb950">&#10003;</text>
  <text x="398" y="192" font-family="JetBrains Mono,monospace" font-size="9" fill="#e6edf3">nonce fresh (SQLite PK)</text>
  <text x="700" y="192" text-anchor="end" font-family="JetBrains Mono,monospace" font-size="9" fill="#484f58">0.04ms</text>
